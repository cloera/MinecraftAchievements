...
public class EventHandler {
	...
	public void craftingEvent(PlayerEvent.ItemCraftedEvent event) {
    	event.player.addChatComponentMessage(new ChatComponentTranslation("Crafted Item ",event.crafting.getItem()).setChatStyle(new ChatStyle().setColor(EnumChatFormatting.AQUA)));
...
//				}
	...
	public void smeltingEvent(PlayerEvent.ItemSmeltedEvent event) {
    	event.player.addChatComponentMessage(new ChatComponentTranslation("Smelted Item ",event.smelting.getItem()).setChatStyle(new ChatStyle().setColor(EnumChatFormatting.AQUA)));
...
//		}
	...
	public void pickupEvent(PlayerEvent.ItemPickupEvent event) {
    	event.player.addChatComponentMessage(new ChatComponentTranslation("Picked Up Item " + event.pickedUp.getEntityItem().getDisplayName()).setChatStyle(new ChatStyle().setColor(EnumChatFormatting.AQUA)));
...
//			}
	...
	//we either should find an alternative, thread this, or keep code as minimal as possible
	@SubscribeEvent
